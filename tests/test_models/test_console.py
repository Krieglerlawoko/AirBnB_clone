...
class TestHBNBCommand_help(unittest.TestCase):
    """tests for help messages of the HBNB command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Tests for exiting from the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Tests for create from the HBNB command interpreter."""
    ...
    def test_create_missing_class(self):
        corct = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create"))
            self.assertEqual(corct, output.getvalue().strip())

    def test_create_invalid_syntax(self):
        corct = "*** Unknown syntax: MyModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("MyModel.create()"))
            self.assertEqual(corct, output.getvalue().strip())
        corct = "*** Unknown syntax: BaseModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Tests for destroy from the HBNB command interpreter."""
    ...
    def test_destroy_objects_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["User.{}".format(tstID)]
            cmmd = "User.destroy({})".format(tstID)
            self.assertFalse(HBNBCommand().onecmd(cmmd))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["State.{}".format(tstID)]
            cmmd = "State.destroy({})".format(tstID)
            self.assertFalse(HBNBCommand().onecmd(cmmd))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Place.{}".format(tstID)]
            cmmd = "Place.destroy({})".format(tstID)
            self.assertFalse(HBNBCommand().onecmd(cmmd))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["City.{}".format(tstID)]
            cmmd = "City.destroy({})".format(tstID)
            self.assertFalse(HBNBCommand().onecmd(cmmd))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Amenity.{}".format(tstID)]
            cmmd = "Amenity.destroy({})".format(tstID)
            self.assertFalse(HBNBCommand().onecmd(cmmd))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Review.{}".format(tstID)]
            cmmd = "Review.destory({})".format(tstID)
            self.assertFalse(HBNBCommand().onecmd(cmmd))
            self.assertNotIn(obj, storage.all())


class TestHBNBCommand_all(unittest.TestCase):
    """tests for all of the HBNB command interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Tests for update from the HBNB command interpreter."""
    ...
    def test_update_missing_attr_name_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
            tstId = output.getvalue().strip()
            tstCmd = "update State {}".format(testId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(tstCmd))
            self.assertEqual(corct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
            tstId = output.getvalue().strip()
            tstCmd = "update Place {}".format(testId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(tstCmd))
            self.assertEqual(corct, output.getvalue().strip())
    ...
    def test_update_missing_attr_value_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update State {} attr_name".format(tstId)
            self.assertFalse(HBNBCommand().onecmd(tstCmd))
            self.assertEqual(corct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update City {} attr_name".format(tstId)
            self.assertFalse(HBNBCommand().onecmd(tstCmd))
            self.assertEqual(corct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update Amenity {} attr_name".format(tstId)
            self.assertFalse(HBNBCommand().onecmd(tstCmd))
            self.assertEqual(corct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update Place {} attr_name".format(tstId)
            self.assertFalse(HBNBCommand().onecmd(tstCmd))
            self.assertEqual(corct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update Review {} attr_name".format(tstId)
            self.assertFalse(HBNBCommand().onecmd(tstCmd))
            self.assertEqual(corct, output.getvalue().strip())
    ...
    def test_update_valid_string_attr_space_notation(self):
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["BaseModel.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["User.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["State.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["City.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["Place.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["Amenity.{}".format(tstId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["Review.{}".format(tstId)].__dict__
        self.assertTrue("attr_value", tst_dict["attr_name"])
    ...
    def test_update_valid_string_attr_dot_notation(self):
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["BaseModel.{}".format(tId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["User.{}".format(tId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["State.{}".format(tId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["City.{}".format(tId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["Place.{}".format(tId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["Amenity.{}".format(tId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
        ...
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["Review.{}".format(tId)].__dict__
        self.assertEqual("attr_value", tst_dict["attr_name"])
    ...
    def test_update_valid_int_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tstId = output.getvalue().strip()
        tstCmd = "update Place {} max_guest 90".format(tstId)
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["Place.{}".format(tstId)].__dict__
        self.assertEqual(90, tst_dict["max_guest"])

    def test_update_valid_int_attr_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
        tstCmd = "Place.update({}, max_guest, 90)".format(tId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
        tst_dict = storage.all()["Place.{}".format(tId)].__dict__
        self.assertEqual(90, test_dict["max_guest"])

    def test_update_valid_float_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tstId = output.getvalue().strip()
        tstCmd = "update Place {} latitude 7.1".format(tstId)
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["Place.{}".format(tstId)].__dict__
        self.assertEqual(7.1, tst_dict["latitude"])

    def test_update_valid_float_attr_dot_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
        tstCmd = "Place.update({}, latitude, 7.1)".format(tId)
        self.assertFalse(HBNBCommand().onecmd(tstCmd))
        tst_dict = storage.all()["Place.{}".format(tId)].__dict__
        self.assertEqual(7.1, tst_dict["latitude"])
    ...
    def test_update_valid_dictionary_with_float_space_notation(self):
        ...
        HBNBCommand().onecmd(tstCmd)
        tst_dict = storage.all()["Place.{}".format(tstId)].__dict__
        self.assertEqual(9.7, test_dict["latitude"])
    ...
    def test_update_valid_dictionary_with_float_dot_notation(self):
        ...
        HBNBCommand().onecmd(testCmd)
        tst_dict = storage.all()["Place.{}".format(tstId)].__dict__
        self.assertEqual(9.7, tst_dict["latitude"])
