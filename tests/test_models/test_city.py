...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("'created_at': " + dte_repr, ctystr)
        self.assertIn("'updated_at': " + dte_repr, ctystr)
...
class TestCity_save(unittest.TestCase):
    """Tests for save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Ttests for testing to_dict method of the City class."""
